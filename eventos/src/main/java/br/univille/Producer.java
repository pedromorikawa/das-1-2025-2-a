...
public class Producer {
    public static void main(String[] args) {
        ...
        String queue = "queue-pedromorikawa";
        ...
        senderClient.sendMessage(new ServiceBusMessage("2: Eu não acredito"));
        senderClient.sendMessage(new ServiceBusMessage("3: Bom dia!"));
    }
}
